...
const assertSnapshotsDua = (Component, configs) => {
  configs.forEach(config => {
    const { props, state, desc, throws, beforeTest } = config;
    const CWithMockState = mockSetState(Component);
    Component = new CWithMockState(props);
...
export { assertSnapshots, mockSetState, assertSnapshotsDua };
export default { assertSnapshots, mockSetState, assertSnapshotsDua };
